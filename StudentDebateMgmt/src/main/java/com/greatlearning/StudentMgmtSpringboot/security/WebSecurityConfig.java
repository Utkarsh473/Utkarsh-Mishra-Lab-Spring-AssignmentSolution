...
import com.greatlearning.StudentMgmtSpringboot.Service.UserDetailsServiceImpl;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers("/student/showFormForUpdate", "/student/delete")
		.hasAuthority("ADMIN")
		...
		.successForwardUrl("/student/readall").permitAll().and().logout().logoutSuccessUrl("/login").permitAll()
